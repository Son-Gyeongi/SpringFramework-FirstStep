...
public class QuizApplication {
	...
	public static void main(String[] args) {
		...
		// quizApplication 빈의 execute() 메서드 실행
	}
...
//		deleteQuiz();
	...
	/*private void setup() {
		...
		// 등록 실행
		quiz1 = repository.save(quiz1); // @Id에 값이 없으니 insert 된다.
		// 등록 확인
	...
	/*private void updateQuiz() {
		...
		// 변경 처리
		quiz1 = repository.save(quiz1); // @Id에 값이 있으니 update 된다.
		// 변경 결과 확인
	 ...
	 */
	private void deleteQuiz() {
		System.out.println("--- 삭체 처리 개시 ---");
		// 삭제 실행
		service.deleteQuizById(2);
		System.out.println("--- 삭체 처리 완료 ---");
	}
